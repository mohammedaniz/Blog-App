...
export default {
    computed : {
      ...mapGetters(['SET_RECORDS_VALUE_ACTION','GET_ALL_BLOGS_SORTED_BY_CREATED_DATE_AND_PAGINATED_GETTER','GET_LOADING_STATUS_GETTER'])
    },
    data(){
        return{
            spinnerStatus : true,
        ...
        loadItemOnScroolBottom(){
          window.onscroll = () => {
            ...
            if (bottomOfWindow) {
              this.SET_RECORDS_VALUE_ACTION(5);
            }
          };
        }
    },components : {
